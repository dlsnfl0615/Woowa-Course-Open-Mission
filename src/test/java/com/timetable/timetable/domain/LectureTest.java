...
class LectureTest {
    ...
    Lecture addedLecture = new Lecture("자바", "최진우", "CSC-1234", addedLectureTimes);
    ...
    void 분반_시간_중복있음() {
        ...
        Lecture lecture2 = new Lecture("", "최진우", "CSC-5678", lectureTimes2);

        List<TimeSlot> lectureTimes3 = List.of(new TimeSlot(Day.MON, LocalTime.of(8, 30), LocalTime.of(10, 0)));
        Lecture lecture3 = new Lecture("c++", "최진우", "CSC-1000", lectureTimes3);
