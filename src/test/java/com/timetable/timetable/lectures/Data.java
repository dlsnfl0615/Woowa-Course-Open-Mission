...
public class Data {
    ...
    public static final Lecture lecture1 =
            new Lecture("자바", "유재석", "CSC-1", lectureTimes1, false);
    ...
    public static final Lecture lecture2 =
            new Lecture("자바", "박명수", "CSC-2", lectureTimes2, false);
    ...
    public static final Lecture lecture3 =
            new Lecture("C++", "정준하", "CSC-3", lectureTimes3, false);
    ...
    public static final Lecture lecture4 =
            new Lecture("C++", "정형돈", "CSC-4", lectureTimes4, false);
    ...
    public static final Lecture lecture5 =
            new Lecture("파이썬", "길", "CSC-5", lectureTimes5, false);
    ...
    public static final Lecture lecture6 =
            new Lecture("파이썬", "노홍철", "CSC-6", lectureTimes6, false);
    ...
    public static final Lecture lecture7 =
            new Lecture("파이썬", "하하", "CSC-7", lectureTimes7, false);
    ...
    public static final Lecture lecture10 =
            new Lecture("자아와명상", "김태호", "ABC-10", lectureTimes10, true);
